...
"use client";
import { ChevronRight, Mail, Shield, Zap, Users, CheckCircle } from "lucide-react";
    ...
    <div className="relative w-full max-w-4xl mx-auto">
      ...
      {!submitted ? (
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              ...
              />
              <span className="text-sm font-mono text-zinc-600">EARLY ACCESS</span>
            ...
            >
              Be among the first to experience AI that understands context, manages your tasks, and lives where you chat—all while keeping your data{" "}
              <span className="text-zinc-800 font-semibold">completely private</span>.
            </motion.p>
          </div>
          ...
          >
            <div className="relative max-w-md mx-auto">
              ...
              >
                {/* Corner accents */}
                <div className={`absolute top-2 left-2 w-3 h-3 border-l border-t transition-colors duration-300 ${focused ? 'border-zinc-400/60' : 'border-zinc-300/40'}`} />
                <div className={`absolute top-2 right-2 w-3 h-3 border-r border-t transition-colors duration-300 ${focused ? 'border-zinc-400/60' : 'border-zinc-300/40'}`} />
                <div className={`absolute bottom-2 left-2 w-3 h-3 border-l border-b transition-colors duration-300 ${focused ? 'border-zinc-400/60' : 'border-zinc-300/40'}`} />
                <div className={`absolute bottom-2 right-2 w-3 h-3 border-r border-b transition-colors duration-300 ${focused ? 'border-zinc-400/60' : 'border-zinc-300/40'}`} />
                ...
                <div className="flex items-center px-6 py-4">
                  ...
                  >
                    <Mail className={`mr-3 transition-colors duration-300 ${focused ? 'text-zinc-700' : 'text-zinc-500'}`} size={20} />
                  </motion.div>
              ...
              >
                ...
                <div className="relative z-10 flex items-center justify-center px-8 py-4">
                  <span className="text-lg font-semibold mr-3">
                    {loading ? "Joinning The Waitlist..." : "Join the Waitlist"}
                  </span>
                  <motion.div
          ...
          >
            <p className="text-sm text-zinc-500 mb-4">Join developers from top companies</p>
            <div className="flex justify-center items-center gap-6 opacity-40">
              {['Microsoft', 'Google', 'Meta', 'Apple', 'OpenAI'].map((company) => (
                <motion.div
                  key={company}
        ...
        >
          ...
          >
            <div className="w-full h-full rounded-2xl bg-gradient-to-br from-green-100 to-green-50 border-2 border-green-200 flex items-center justify-center text-4xl">
              ✨
            </div>
          ...
          >
            ...
            <div className="p-6 text-center">
              ...
              >
                <CheckCircle className="text-green-500" size={20} />
                <span className="text-sm font-mono text-zinc-600">REGISTRATION CONFIRMED</span>
              </motion.div>
              
              <p className="text-zinc-700 leading-relaxed">
                You&apos;re now on the exclusive waitlist! We&apos;ll notify you the moment SynkList is ready to transform your WhatsApp into an AI command center.
              </p>
          ...
          >
            <motion.div
              className="px-6 py-2 rounded-xl bg-zinc-900 text-white font-medium hover:bg-zinc-800 transition-colors"
