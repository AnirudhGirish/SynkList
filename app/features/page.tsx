      ...
      <main ref={containerRef} className="relative">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-zinc-600 max-w-3xl mx-auto">
                Discover the comprehensive capabilities that make SynkList the
                most powerful AI assistant for WhatsApp.
              </p>
            </motion.div>
                ...
                <div className="p-12">
                  <div className="text-center mb-12">
                    ...
                    <p className="text-zinc-600 max-w-2xl mx-auto">
                      Experience the future of productivity with our advanced
                      feature set designed for the modern professional. All
                      inside Whatsapp.
                    </p>
                  </div>
        ...
        <section className="relative py-20 px-6 border-t border-zinc-200/40">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              We&apos;re crafting comprehensive feature documentation with
              interactive demos, use cases, and implementation guides. Stay
              tuned for an in-depth exploration of SynkList&apos;s capabilities.
            </motion.p>
